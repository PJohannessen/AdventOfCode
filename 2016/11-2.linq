...
void Main()
{
    ...
    */
    ...
    int[] initialStateDetails = new int[] { 3, 3, 3, 3, 3, 2, 1, 2, 2, 2, 2, 3, 3, 3, 3 }; 
        ...
        */
        if (_state[2] != _state[1] &&
           (_state[2] == _state[3] ||
            ...
            _state[2] == _state[9] ||
            _state[2] == _state[11] ||
            _state[2] == _state[13])) return false;
        if (_state[4] != _state[3] &&
           (_state[4] == _state[1] ||
            ...
            _state[4] == _state[9] ||
            _state[4] == _state[11] ||
            _state[4] == _state[13])) return false;
        if (_state[6] != _state[5] &&
           (_state[6] == _state[1] ||
            ...
            _state[6] == _state[9] ||
            _state[6] == _state[11] ||
            _state[6] == _state[13])) return false;
        if (_state[8] != _state[7] &&
           (_state[8] == _state[1] ||
            ...
            _state[8] == _state[9] ||
            _state[8] == _state[11] ||
            _state[8] == _state[13])) return false;
        if (_state[10] != _state[9] &&
           (_state[10] == _state[1] ||
            ...
            _state[10] == _state[7] ||
            _state[10] == _state[11] ||
            _state[10] == _state[13])) return false;
        if (_state[12] != _state[11] &&
           (_state[12] == _state[1] ||
            _state[12] == _state[3] ||
            _state[12] == _state[5] ||
            _state[12] == _state[7] ||
            _state[12] == _state[9] ||
            _state[12] == _state[13])) return false;
        if (_state[14] != _state[13] &&
           (_state[14] == _state[1] ||
            _state[14] == _state[3] ||
            _state[14] == _state[5] ||
            _state[14] == _state[7] ||
            _state[14] == _state[9] ||
            _state[14] == _state[11])) return false;
        return true;
    }
